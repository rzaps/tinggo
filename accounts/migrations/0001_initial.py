    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('organizer', 'Event Organizer'), ('participant', 'Event Participant'), ('vendor', 'Vendor/Partner'), ('host', 'Experience Host')], default='participant', max_length=20, verbose_name='user role')),
                ...
                ('language', models.CharField(choices=[('en', 'English'), ('es', 'Español'), ('ht', 'Kreyòl Ayisyen')], default='en', max_length=10, verbose_name='preferred language')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('username', models.CharField(blank=True, error_messages={'unique': 'A user with that username already exists.'}, help_text='Optional. 150 characters or fewer.', max_length=150, null=True, unique=True, verbose_name='username')),
